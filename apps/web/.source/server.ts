...
import * as __fd_glob_14 from "../content/docs/concepts/secrets-and-certificates.mdx?collection=docs"
import * as __fd_glob_13 from "../content/docs/concepts/monitors-and-runs.mdx?collection=docs"
import * as __fd_glob_12 from "../content/docs/concepts/glossary.mdx?collection=docs"
import * as __fd_glob_11 from "../content/docs/concepts/elf-log-checks.mdx?collection=docs"
import * as __fd_glob_10 from "../content/docs/concepts/deployment-validation.mdx?collection=docs"
import * as __fd_glob_9 from "../content/docs/concepts/applications.mdx?collection=docs"
import * as __fd_glob_8 from "../content/docs/concepts/alerts.mdx?collection=docs"
import * as __fd_glob_7 from "../content/docs/getting-started/your-first-monitor.mdx?collection=docs"
import * as __fd_glob_6 from "../content/docs/getting-started/what-is-rythm.mdx?collection=docs"
import * as __fd_glob_5 from "../content/docs/getting-started/navigating-the-console.mdx?collection=docs"
...
export const docs = await create.docs("docs", "content/docs", {"meta.json": __fd_glob_0, "getting-started/meta.json": __fd_glob_1, "guides/meta.json": __fd_glob_2, "concepts/meta.json": __fd_glob_3, }, {"index.mdx": __fd_glob_4, "getting-started/navigating-the-console.mdx": __fd_glob_5, "getting-started/what-is-rythm.mdx": __fd_glob_6, "getting-started/your-first-monitor.mdx": __fd_glob_7, "concepts/alerts.mdx": __fd_glob_8, "concepts/applications.mdx": __fd_glob_9, "concepts/deployment-validation.mdx": __fd_glob_10, "concepts/elf-log-checks.mdx": __fd_glob_11, "concepts/glossary.mdx": __fd_glob_12, "concepts/monitors-and-runs.mdx": __fd_glob_13, "concepts/secrets-and-certificates.mdx": __fd_glob_14, "guides/certificate-profiles.mdx": __fd_glob_15, "guides/configuring-elf-queries.mdx": __fd_glob_16, "guides/creating-a-monitor.mdx": __fd_glob_17, "guides/importing-monitors.mdx": __fd_glob_18, "guides/managing-applications.mdx": __fd_glob_19, "guides/managing-secrets.mdx": __fd_glob_20, "guides/notification-settings.mdx": __fd_glob_21, "guides/running-deployment-validation.mdx": __fd_glob_22, "guides/testing-and-publishing-monitors.mdx": __fd_glob_23, "guides/viewing-runs-and-history.mdx": __fd_glob_24, "guides/working-with-alerts.mdx": __fd_glob_25, });